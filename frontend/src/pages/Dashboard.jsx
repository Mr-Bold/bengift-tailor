...
function Dashboard({ ctx, setPage }) {
  ...
  const filteredJobs = recentJobs.filter(job => {
    ...
    const customerMatch = job.customerName?.toLowerCase().includes(searchLower)
    const jobNoMatch = job.jobNo?.toLowerCase().includes(searchLower)
    const itemsMatch = job.items?.some(item => item.item?.toLowerCase().includes(searchLower))
    
    return customerMatch || jobNoMatch || itemsMatch
  })
