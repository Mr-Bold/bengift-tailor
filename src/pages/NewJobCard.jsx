...
import { sendSMS, SMS_CONFIG } from '../config/sms.config'
              ...
              <div className="images-section">
                <div className="image-box">
                  ...
                  <div className="image-buttons">
                    <button className="btn-image" onClick={() => document.getElementById('image1-input').click()}>Hand Note</button>
                    <button className="btn-image" onClick={() => alert('Web Cam feature coming soon')}>Web Cam</button>
                    <button className="btn-image" onClick={() => handleClearImage('image1')}>Clear</button>
                    <input 
                      id="image1-input"
                      type="file" 
                      accept="image/*"
                  ...
                  <div 
                    ...
                    style={{backgroundImage: images.image1 ? `url(${images.image1})` : 'none'}}
                  >
                    {!images.image1 && <span className="image-placeholder-text">No Image</span>}
                  </div>
                </div>
                ...
                <div className="image-box">
                  ...
                  <div className="image-buttons">
                    <button className="btn-image" onClick={() => document.getElementById('image2-input').click()}>Insert Image</button>
                    <button className="btn-image" onClick={() => alert('Web Cam feature coming soon')}>Web Cam</button>
                    <button className="btn-image" onClick={() => handleClearImage('image2')}>Clear</button>
                    <input 
                      id="image2-input"
                      type="file" 
                      accept="image/*"
                  ...
                  <div 
                    className="image-placeholder"
                    style={{backgroundImage: images.image2 ? `url(${images.image2})` : 'none'}}
                  >
                    {!images.image2 && <span className="image-placeholder-text">No Image</span>}
                  </div>
                </div>
              </div>
            </div>
